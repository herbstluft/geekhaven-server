...
<body id="body" class="dark-mode" style="margin: 3%;">
  ...
  <path fill-rule="evenodd" d="M11.354 1.646a.5.5 0 0 1 0 .708L5.707 8l5.647 5.646a.5.5 0 0 1-.708.708l-6-6a.5.5 0 0 1 0-.708l6-6a.5.5 0 0 1 .708 0z"/>
    ...
    if (isset($_SESSION['user']) && $id == $_SESSION['user'] )  {
        echo '<img class="profile-image" style="width:30px; height:30px;" src="/src/views/admin/html/img_profile/'.$imagen.'" alt="Perfil Chat 1">';
    } elseif (isset($_SESSION['admin']) && $id == $_SESSION['admin']) {
        echo '<img class="profile-image" style="width:30px; height:30px;" src="/src/views/user/img_profile/'.$imagen.'" alt="Perfil Chat 1">';
    }          
  ...
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
        ...
        <div>
            ...
            <?php 
                    ...
                    // Imagen del perfil
    if (isset($_SESSION['user']) && $id == $_SESSION['user'] )  {
        echo '<img class="profile-image"style="margin-bottom:10px; width:90px; height:90px;" src="/src/views/admin/html/img_profile/'.$imagen.'" alt="Perfil Chat 1">';
    } elseif (isset($_SESSION['admin']) && $id == $_SESSION['admin']) {
        echo '<img class="profile-image" style="margin-bottom:10px; width:90px; height:90px;" src="/src/views/user/img_profile/'.$imagen.'" alt="Perfil Chat 1">';
    }          
    ?>
