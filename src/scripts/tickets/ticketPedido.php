...
<html lang="en">
  ...
  <body>
    <div class="mx-auto  p-5" style="width:100%">
<center>
        <H1 align="center">TICKET REIMPRESO</H1>
        
            <h3 align="center">Este es un ticket reimpreso emitido por GeekHaven <p>NO ES EL TICKET ORIGINAL</p></h3>
    ...
    <div class=" ">
        ...
        <h2 align="center" class="text-danger">No° de pedido:<?php echo $id_o;?></h2>
...
$HOST=$_SERVER['SERVER_NAME'];
header("refresh: 3; url=http://'.$HOST.'/index.php");
?>
