...
<html lang="en">
  ...
  <div class="alert alert-primary" role="alert">
    ...
    <h4 class="alert-heading col-12" align="center">TU TICKET DEBE DESCARGARSE EN BREVE</h4>
        <p class="" align="center">Si tu ticket no se ha descargado da click <a href="/src/scripts/tickets/ticketPedido.php?id_o=<?php echo $id_orden?>&usr=<?php echo $usr?>&id_orden=<?php echo $id_o?>">aqui</a></p>
        <hr>
        <p align="center">Si tu ticket ya ha sido descargado puedes volver a la pagina</p>
        
        <center>
        <a href="/index.php" class="btn btn-primary pt-2 pb-2 fs-5">Click aqui para volver</a>
        </center>
    </div>
  ...
  <?php
  header("refresh:3;url=/src/scripts/tickets/ticketPedido.php?id_o=$id_orden&id_orden=$id_o")
  ?>
