...
if (isset($_GET['id'])) {
  ...
  if(empty($validacion)){
    ...
    $result = $db->ejecutarConsulta($update_query);
      if ($result) {
      header("Location:/src/views/admin/html/editar_producto.php?mensaje=success");
      ...
      header("Location:/src/views/admin/html/editar_producto.php?mensaje=failed&prd=$id");
  }
