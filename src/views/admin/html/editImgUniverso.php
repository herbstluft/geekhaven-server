...
<br><br><br>
   ...
   <hr>
   <a href="/src/views/admin/html/editUniverso.php" class="">
...
if($_GET['id']){
    ...
    if(!isset($Imagenes)){
      ...
      <center>  <img width="410" height="410" src="/src/scripts/insersiones/<?php echo $res['img']?>" ></center> 
        </div>
  ...
  <div class="col-sm-12 col-md-5 me-5">
    ...
    <form action="/src/scripts/insersiones/editImgUniverso.php" method="post" enctype="multipart/form-data">
      <div class="mb-3">
