...
<br><br>       
    ...
    <a href="/src/views/admin/html/aggexistencia.php?id=<?php echo $fila['id_producto']?>"> <img src="/src/views/admin/html/img_producto/<?php 
                foreach($sacarImg as $img)
                echo $img['nombre_imagen'];?>" class="d-block w-100"  height="310px" alt=""> <?php ?></a>
