...
if($_GET['id']){
 ...
 ?>
  ...
  <div class="col-sm-12 col-md-5">
    ...
    <form action="/src/scripts/insersiones/editNomUniverso.php" method="post" enctype="multipart/form-data">
      <div class="mb-3">
...
?>
 ...
 <script src="/bootstrap/js/upload_photo_multiple.js"></script>
