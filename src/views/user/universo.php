...
<center><h1>UNIVERSO <?php echo $nombre_universo; ?> </h1></center>
<br>
...
<div class="row" style="width: 100%; display:none;"  id="contenidoopcion1" >
    ...
    $sacarImgQry_prd = "SELECT * FROM productos INNER JOIN img_productos ON img_productos.id_producto = productos.id_producto WHERE productos.id_producto = $id_producto_prd ";
    ...
    $sacarImgQry_popular = "SELECT * FROM productos INNER JOIN img_productos ON img_productos.id_producto = productos.id_producto WHERE productos.id_producto = $id_producto_popular ";
...
<div class="row" style="width: 100%; display:none;"  id="contenidoopcion3" >
    ...
    $sacarImgQry_az = "SELECT * FROM productos INNER JOIN img_productos ON img_productos.id_producto = productos.id_producto WHERE productos.id_producto = $id_producto_az ";
