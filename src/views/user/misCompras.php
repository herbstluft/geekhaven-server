...
WHERE u.id_usuario=$usr and do.estatus = 2
GROUP BY
    o.id_orden, p.id_producto,  do.fecha_detalle, u.id_usuario, YEAR(o.fecha), MONTH(o.fecha), DAY(o.fecha), p.nom_producto
                ...
                <div class="col-5" style="margin-bottom:30px">
                 ...
                 <table class="table col-12 table-responsive " id="tabla">
                    ...
                    <?php
                      ...
                      <?php 
 $id_producto=$id_prd;
                          $sacarImgQry="SELECT nombre_imagen from productos INNER JOIN img_productos on img_productos.id_producto=productos.id_producto where productos.id_producto=$id_producto ";
                          ...
                          if(!empty($imgp)){ ?>
                          <img src="/src/views/admin/html/img_producto/<?php echo $imgp ?>" class=" ms-5" width="120px" height="130px" alt="...">
