      ...
      <div class="row">
          ...
          <div class="col-sm-12 col-md-6 ">
                  ...
                  <?php 
                     ...
                     if(!empty($imagen)){ ?>
<center><img src="/src/views/admin/html/img_producto/<?php echo $imagen; ?>" class="img-fluid" style="max-width: 100%;margin-top:50px; max-height: 400px;" alt="..."></center>
                        <?php 
                        }
                        else { ?>
...
?>
                          ...
                          <!-- Modal -->
                          <form action="/src/scripts/cart/addPrdCart.php" method="GET">
                          <div class="mb-3">
                              <!--prd--> 
