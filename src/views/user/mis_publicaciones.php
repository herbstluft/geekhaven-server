            ...
            <div class="card" style="height: 100%;">
                <div class="card-body">
                    <?php if (!empty($imagenes_por_publicacion)) { ?>
                        <img src="/src/views/user/img_pub_trq/<?php echo $imagenes_por_publicacion[0]['nombre_imagen']; ?>" class="card-img-top" height="310px" alt="No hay imágenes">
                    <?php } else { ?>
                    ...
                    <div class="card-body pt-3 p-4">
                        ...
                        <center>
                            ...
                            echo '<img class="profile-image" style="width:35px; height:35px;border-radius:50%; margin-top:15px" src="/src/views/user/img_profile/' . $imagen . '" alt="Perfil Chat 1">';
                            ?>
                            &ensp;&ensp; 
