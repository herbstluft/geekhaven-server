...
<body>
<?php include($_SERVER['DOCUMENT_ROOT'] . '/templates/navbar_user.php'); ?>
...
<div class="row" style="width: 100%; display:none;"  id="contenidoopcion1" >
                <?php foreach ($prd as $prd) {
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="scroll-appear">
                                ...
                                <a href="/src/views/user/productos.php?id=<?php echo $prd['id_producto']; ?>">
    <?php
    $id_producto_prd = $prd['id_producto'];
    $sacarImgQry_prd = "SELECT * FROM productos INNER JOIN img_productos ON img_productos.id_producto = productos.id_producto WHERE productos.id_producto = $id_producto_prd  AND productos.existencia>0  ";
    ...
    <?php if (!empty($img_nombre_prd)) { ?>
        <img src="/src/views/admin/html/img_producto/<?php echo $img_nombre_prd; ?>" class="d-block w-100" height="310px" alt="...">
    <?php } else { ?>
                ...
                <?php foreach ($populares as $popular) {?>
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="scroll-appear">
                                ...
                                <div class="position-relative">
                                <a href="/src/views/user/productos.php?id=<?php echo $popular['id_producto']; ?>">
    <?php
    $id_producto_popular = $popular['id_producto'];
    $sacarImgQry_popular = "SELECT * FROM productos INNER JOIN img_productos ON img_productos.id_producto = productos.id_producto WHERE productos.id_producto = $id_producto_popular  AND productos.existencia>0 ";
    ...
    <?php if (!empty($img_nombre_popular)) { ?>
        <img src="/src/views/admin/html/img_producto/<?php echo $img_nombre_popular; ?>" class="d-block w-100" height="310px" alt="...">
    <?php } else { ?>
        <img src="https://static.vecteezy.com/system/resources/previews/004/141/669/non_2x/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg" class="d-block w-100" height="310px" alt="...">
    <?php } ?>
</a>
...
<div class="row" style="width: 100%; display:none;"  id="contenidoopcion3" >
                <?php foreach ($productosaz as $productoaz) {?>
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="scroll-appear">
                                ...
                                <div class="position-relative">
                                <a href="/src/views/user/productos.php?id=<?php echo $productoaz['id_producto']; ?>">
    <?php
    $id_producto_az = $productoaz['id_producto'];
    $sacarImgQry_az = "SELECT * FROM productos INNER JOIN img_productos ON img_productos.id_producto = productos.id_producto WHERE productos.id_producto = $id_producto_az  AND productos.existencia>0 ";
    ...
    <?php if (!empty($img_nombre_az)) { ?>
        <img src="/src/views/admin/html/img_producto/<?php echo $img_nombre_az; ?>" class="d-block w-100" height="310px" alt="...">
    <?php } else { ?>
        <img src="https://static.vecteezy.com/system/resources/previews/004/141/669/non_2x/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg" class="d-block w-100" height="310px" alt="...">
    <?php } ?>
</a>
...
<div class="row" style="width: 100%; display:none;"  id="contenidoopcion4" >
                    ...
                    <div class="col-sm-6 col-xl-3">
                            ...
                            <div class="scroll-appear">
                                ...
                                <div class="position-relative">
                                   ...
                                   <a href="/src/views/user/productos.php?id=<?php echo $productoza['id_producto'];
                                   
                                  $id_producto=$productoza['id_producto'];
                     $sacarImgQry="SELECT *  from productos INNER JOIN img_productos on img_productos.id_producto=productos.id_producto where productos.id_producto=$id_producto  AND productos.existencia>0 ";
                     $sacarImg=$db1->seleccionarDatos($sacarImgQry);
                foreach($sacarImg as $imgza){
                $img_za = $imgza['nombre_imagen'];} ?>"> 

                <?php     if(!empty($img_za)){ ?>
                    <img src="/src/views/admin/html/img_producto/<?php echo $img_za ?>" class="d-block w-100"  height="310px" alt="...">
                ...
                foreach ($con as $fila) {
                    ?>
                        ...
                        <div class="scroll-appear">
                            <div class="card overflow-hidden rounded-2">
                            <div class="position-relative">
    <a href="/src/views/user/productos.php?id=<?php echo $fila['id_producto']?>">
    ...
    <?php $id_producto=$fila['id_producto'];
                ...
                if(!empty($img0)){ ?>
    <img src="/src/views/admin/html/img_producto/<?php echo $img0 ?>" class="d-block w-100"  height="310px" alt="...">
