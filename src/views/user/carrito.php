          ...
          <tbody>
            ...
            <tr>
              ...
              <?php $id_producto=$res['id_producto'];
                ...
                if(!empty($imgc)){?>
              <img src="/src/views/admin/html/img_producto/<?php echo $imgc ?>" class="d-block" width="80"  height="80" alt="...">
              ...
              <td class="fs-3"><br><?php echo '$'.$res['total'];?> <br> <a href="/src/scripts/cart/quitarPrdCart.php?id=<?php echo $res['id_producto'];?>&usr=
      ...
      <div class="col">
        ...
        <thead>
          ...
          <tbody >
              ...
              <tr>
                <td colspan="2">
                  <a href="/src/scripts/cart/validacionCart.php?orden=<?php echo $id_orden ?>" class="col-12 btn btn-danger" style="font-size: 20px">FINALIZAR COMPRA</a>
                </td>
              </tr>
          </tbody>
        </table>
