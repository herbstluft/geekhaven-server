...
<?php 
if(isset($_SESSION['admin'])){
  include($_SERVER['DOCUMENT_ROOT'] . '/src/views/admin/html/navbar.php');
}
if(isset($_SESSION['user'])){
  include($_SERVER['DOCUMENT_ROOT'] . '/templates/navbar_user.php');
} ?>
...
<br>
    ...
    <form action="mi_cuenta.php" method="post" enctype="multipart/form-data" style="display:contents;margin-top: 0;">
