...
<br><br>       
        ...
        <div class="row"  style="margin-left:20px">
            ...
            if (!empty($con)) {
              ...
              if(!empty($imgb)){ ?>
    <a href="/src/views/user/productos.php?id=<?php echo $fila['id_producto']?>"><img src="/src/views/admin/html/img_producto/<?php echo $imgb; ?>" class="d-block w-100"  height="310px" alt="..."></a>

              <?php
              }else{ ?>
    <a href="/src/views/user/productos.php?id=<?php echo $fila['id_producto']?>"><img src="https://static.vecteezy.com/system/resources/previews/004/141/669/non_2x/no-photo-or-blank-image-icon-loading-images-or-missing-image-mark-image-not-available-or-image-coming-soon-sign-simple-nature-silhouette-in-frame-isolated-illustration-vector.jpg" class="d-block w-100"  height="310px" alt="..."></a>
              <?php
              }
              ?>
